...
bool addHead(List *&L, int data)
{
    ...
    if (L->p_head == nullptr){
        ...
        // Cho node vừa tạo trỏ về null
        tempNode->p_prev = nullptr;
...
void removeTail(List *&L)
{
    ...
    // Nếu list có nhiều phần tử
        ...
        // prev lấy phần tử trước phần tử trước tail
        NODE* prev = nullptr;
        // cur lấy phần tử trước tail
        NODE* cur = L->p_head;
        // Lấy node trước tail
...
void removeBefore(List *&L, int val)
{
    ...
    if (L->p_head == nullptr || L->p_head->p_next == nullptr){
        ...
        // cur là vị trí cần tìm val
        NODE* cur = L->p_head;
        // prev là vị trí cần giữ lại
        NODE* prev = nullptr;
...
void removeAfter(List *&L, int val)
{
    // List rỗng / có 1 phần tử -> trả về list
    if (L->p_head == nullptr || L->p_head->p_next == nullptr){
        return;
    }
